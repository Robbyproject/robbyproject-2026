export const translations = {
  en: {
    ...
    about_intro_2: "I combine creative design with technical expertise using Next.js, TypeScript, and Tailwind CSS to deliver intuitive and high-performance user experiences. As a detail-oriented and collaborative individual, I’m committed to producing well-structured, efficient, and impactful work that provides real value to users.",
    about_regards: "Best regards,",
    about_career: "Career",
    about_edu: "Education",
    btn_resume: "Resume",
  ...
  id: {
    ...
    about_intro_2: "Saya menggabungkan kreativitas desain dengan kemampuan teknis menggunakan Next.js, TypeScript, dan Tailwind CSS untuk membangun pengalaman pengguna yang intuitif dan berkinerja tinggi. Sebagai pribadi yang detail-oriented dan senang berkolaborasi, saya berkomitmen menghadirkan karya yang terstruktur dengan baik, efisien, dan memberikan dampak positif bagi pengguna.",
