...
export default function About() {
    ...
    return (
        <motion.section
            id="about"
            className="py-16 sm:py-24 px-4 sm:px-6 w-full max-w-[95%] xl:max-w-7xl mx-auto text-center"
        ...
        >
            ...
            <div className="relative bg-[#1a1a1a] rounded-2xl shadow-2xl border border-white/10 overflow-hidden group">
                ...
                <div className="px-8 pb-10 -mt-24 relative z-10 flex flex-col items-center">
                    <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 [perspective:1000px] mb-4">
                        <motion.div
                    ...
                    <p className="text-gray-300 max-w-2xl font-sans leading-relaxed text-base md:text-lg">
