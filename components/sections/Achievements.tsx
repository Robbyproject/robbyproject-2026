        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {filtered.map((cert) => (
               <CardSpotlight 
                  ...
                  className="group flex flex-col sm:flex-row gap-6 bg-white dark:bg-[#18181b] p-4 sm:p-6 rounded-2xl border border-zinc-200 dark:border-white/5 hover:border-cyan-500/30 transition-all duration-300 shadow-md dark:shadow-none items-start sm:items-center"
               >
