...
import {
  SiGmail, SiInstagram, SiWhatsapp, SiGithub, SiBehance
} from "react-icons/si";
    ...
    <div className="w-full space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <div className="p-5 sm:p-8 md:p-10 relative z-20 h-full flex flex-col justify-between min-h-[240px] sm:min-h-[320px]">
            ...
            <div className="space-y-6 mt-8">
              <div>
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-zinc-900 dark:text-white mb-2 tracking-tight">
                  {firstItem.title}
                </h3>
