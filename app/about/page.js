...
import { useLanguage } from "@/components/providers/AppProviders"; // Import Hook Bahasa

// Data Career & Education (Bisa tetap statis atau dipindah ke locales jika ingin translate isinya juga)
const careerList = [
  {
          ...
          <div className="max-w-5xl mx-auto px-6 py-10 lg:py-14">
             ...
             <div>
                ...
                <div className="flex justify-end mb-6">
                    <button className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-[#18181b] border border-zinc-200 dark:border-white/10 rounded-lg text-xs font-medium text-zinc-600 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-white/5 transition-all shadow-sm">
                        <Download size={14} /> {t.btn_resume}
                    </button>
                </div>
