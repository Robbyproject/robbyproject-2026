...
export default function ProjectsPage() {
    ...
    const filteredProjects = useMemo(() => {
        return projects.filter((project) => {
            ...
            const matchesSearch = title.includes(query) || desc.includes(query) || toolsString.includes(query);
    ...
    return (
        <div className="w-full space-y-10 min-h-screen pb-20 pt-4">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 border-b border-zinc-200 dark:border-white/5 pb-8">
                ...
                {/* --- BAGIAN SEARCH & FILTER (DIPERBAIKI) --- */}
                {/* Menggunakan 'flex-row' agar selalu sejajar ke samping */}
                <div className="flex flex-row items-center gap-2 w-full lg:w-auto relative z-20">

                    {/* 1. Search Bar (Gunakan flex-1 agar mengisi ruang kosong) */}
                    ...
                    {/* 2. Dropdown Filter (shrink-0 agar tidak gepeng) */}
                    <div className="relative shrink-0" ref={filterRef}>
                        ...
                        >
                            <div className="flex items-center gap-2">
                                <ListFilter size={16} />
                                {/* Teks disembunyikan di layar sangat kecil, muncul di HP normal ke atas */}
            ...
            {/* --- CONTENT GRID (Responsive: 1 kolom di HP, 2 di Tablet, dst) --- */}
            {loading ? (
